...
var customerDetails:[number , string ,number , boolean] = [1, "John" , 20 , false];
...
var customerDetails_2 : [any , any , boolean] = [ 12222222, "adafsfasdasdfas" , true ] ;
...
//object
var cusomer_deails_1 : {cusname1:string,age1:number,loc1:string} = { cusname1: "john", age1: 30 , loc1:"bengolore" };
